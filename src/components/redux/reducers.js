...
//humhe nayi array bnani padhegi kyuki humhe state update karana hain,toh humhe mutate nhi karana hain state taki re-render kar sake new state se

let reducer = (state = initialState, action) => {
	let cp = [];
	let id = -1;
	switch (action.type) {
		//cases have same scope, so we can't declare same variable 2 times
